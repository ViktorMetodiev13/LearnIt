...
function App() {
    ...
    <div className="welcome-message">
        ...
        <h3>LearnIt is the perfect place for you. With our professional courses you can achieve the height of success in
            no time</h3>
        <p>Don't know where to start? We suggest <a href="#">Courses</a></p>
    </div>
    ...
    <section id="game-details">
        ...
        <div className="info-section">
            ...
            <div className="game-header">
                <img className="game-img" src="./images/reactLogo.jpg" />
                <h1>React JS</h1>
                <span className="levels">Time to Complete: 8 weeks</span>
                <p className="type">Technology, Coding, JS</p>
            </div>
